...
if __name__ == '__main__':
  ...
  if args.net=='inception_v3':
    ...
    net = resnet_fusion_late_fusion(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=101)
  elif args.net == 'res101_fusion_noise':
    net = resnet_fusion_noise(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=101)
    ...
    net = resnet_fusion_multi(batch_size=cfg.TRAIN.IMS_PER_BATCH, num_layers=101)
