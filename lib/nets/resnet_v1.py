...
class resnetv1(Network):
  ...
  def get_variables_to_restore(self, variables, var_keep_dic):
    ...
    temp_var=[self._resnet_scope + '/conv1/weights:0']
    #temp_var=[self._resnet_scope + '/conv1/weights:0',self._resnet_scope + '/cls_score/weights/Momentum:0',self._resnet_scope + '/bbox_pred/weights/Momentum:0',
    #self._resnet_scope + '/cls_score/biases/Momentum:0',self._resnet_scope + '/bbox_pred/biases/Momentum:0']
    for v in variables:
      # exclude the first conv layer to swap RGB to BGR
      if v.name in temp_var:
